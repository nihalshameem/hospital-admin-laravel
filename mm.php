...
<head>
    ...
    <title>Laravel | Mother Registration</title>
	
	<meta name="description" content="Mother Registration Form"/>
    <!-- Favicon icon -->
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="https://lingamexports.in/public/patient">Mother Registration</a></li>
                        <li><a href="#">Mother Medical</a></li>
                            <li><a href="#">Mother AN List</a></li>
