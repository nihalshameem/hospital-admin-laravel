								...
								<div class="assigned-doctor owl-carousel">
									<div class="items">
										<div class="text-center">
											...
											<h5 class="fs-16 mb-1 font-w600"><a class="text-black" href="{!! url('/page-review'); !!}">Dr. Alexandro Jr.</a></h5>
									...
									<div class="items">
										<div class="text-center">
											...
											<div class="dr-star"><i class="las la-star"></i> 4.2</div>
											<h5 class="fs-16 mb-1 font-w600"><a class="text-black" href="{!! url('/page-review'); !!}">Dr. Samantha</a></h5>
									...
									<div class="items">
										<div class="text-center">
											...
											<div class="dr-star"><i class="las la-star"></i> 4.2</div>
											<h5 class="fs-16 mb-1 font-w600"><a class="text-black" href="{!! url('/page-review'); !!}">Dr. Aliandro M</a></h5>
									...
									<div class="items">
										<div class="text-center">
											...
											<div class="dr-star"><i class="las la-star"></i> 4.2</div>
											<h5 class="fs-16 mb-1 font-w600"><a class="text-black" href="{!! url('/page-review'); !!}">Dr. Samuel</a></h5>
									...
									<div class="items">
										<div class="text-center">
											...
											<div class="dr-star"><i class="las la-star"></i> 4.2</div>
											<h5 class="fs-16 mb-1 font-w600"><a class="text-black" href="{!! url('/page-review'); !!}">Dr. Melinda</a></h5>
											<span class="text-primary mb-2 d-block">Dentist</span>
											<p class="fs-12">795 Folsom Ave, Suite 600 San Francisco, CADGE 94107</p>
											<div class="social-media">
												<a href="javascript:void(0);"><i class="lab la-instagram"></i></a>
                                    ...
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-panel flex-wrap">
                                                ...
                                                <div class="media-body">
													<h5 class="mb-1"><a class="text-black" href="{!! url('/patient-details'); !!}">Aziz Bakree</a></h5>
                                        ...
                                        <li>
                                            <div class="timeline-panel flex-wrap">
                                                ...
                                                <div class="media-body">
													<h5 class="mb-1"><a class="text-black" href="{!! url('/patient-details'); !!}">Griezerman</a></h5>
													<span class="fs-14">24 Years</span>
												</div>
                                        ...
                                        <li>
                                            <div class="timeline-panel flex-wrap">
                                                ...
                                                <div class="media-body">
													<h5 class="mb-1"><a class="text-black" href="{!! url('/patient-details'); !!}">Oconner</a></h5>
													<span class="fs-14">24 Years</span>
												</div>
										 ...
										 <li>
                                            <div class="timeline-panel flex-wrap">
                                                ...
                                                <div class="media-body">
													<h5 class="mb-1"><a class="text-black" href="{!! url('/patient-details'); !!}">Uli Trumb</a></h5>
													<span class="fs-14">24 Years</span>
												</div>
