                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" id="anc_period"
                                                        name="anc_period" value="{{ @$mother_visit->anc_period }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                                        ...
                                                        name="post_prandial" value="{{ @$mother_visit->post_prandial }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" id="high_risk_other"
                                                        ...
                                                        value="{{ @$mother_visit->high_risk_other }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="form-control" id="wife_hiv_screeing_result"
                                                            ...
                                                            <option value="positive"
                                                                {{ @$mother_visit->wife_hiv_screeing_result == 'positive' ? 'selected' : '' }}>
                                                                +ve</option>
                                                            <option value="negative"
                                                                {{ @$mother_visit->wife_hiv_screeing_result == 'negative' ? 'selected' : '' }}>
                                                                -ve</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="form-control" id="husband_hiv_screeing_result"
                                                            ...
                                                            <option value="">Select </option>
                                                            <option value="positive"
                                                                {{ @$mother_visit->husband_hiv_screeing_result == 'positive' ? 'selected' : '' }}>
                                                                +ve</option>
                                                            <option value="negative"
                                                                {{ @$mother_visit->husband_hiv_screeing_result == 'negative' ? 'selected' : '' }}>
                                                                -ve</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="form-control" id="vdrl_result" name="vdrl_result">
                                                            <option value="Reactive"
                                                                {{ @$mother_visit->vdrl_result == 'Reactive' ? 'selected' : '' }}>
                                                                Reactive</option>
                                                            <option value="Non-reactive"
                                                                {{ @$mother_visit->vdrl_result == 'Non-reactive' ? 'selected' : '' }}>
                                                                Non-reactive</option>
