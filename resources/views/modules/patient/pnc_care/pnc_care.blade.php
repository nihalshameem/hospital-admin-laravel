            ...
            <div class="col-lg-12">
                <div class="card" style="height: auto;">
                    <div class="card-header" style="background-color: #ffb800;">
                        <h4 class="card-title">Welcome R.Baby - VHN</h4>
                    </div>
                    <div class="card-body">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb custom-breadcrumb">
                                <li class="breadcrumb-item">District: KALLAKURICHI</li>
                                <li class="breadcrumb-item">HUD: KALLAKURICHI</li>
                                <li class="breadcrumb-item">Rural/Urban: Rural</li>
                                <li class="breadcrumb-item">Block: KALLAKURICHI</li>
                                <li class="breadcrumb-item">PHC: EDUTHAVAINATHAM</li>
                                <li class="breadcrumb-item">HSC: MATHUR</li>
                            </ol>
                        </nav>
                        <ol class="br">
                        </ol>
