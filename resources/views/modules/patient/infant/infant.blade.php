                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="vhn_name"
                                                            name="vhn_name" value="">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="opv_o_dose"
                                                            name="opv_o_dose" placeholder="DD/MM/YYYY" value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="bcg_dose"
                                                            name="bcg_dose" placeholder="DD/MM/YYYY" value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="hep_o_dose"
                                                            name="hep_o_dose" placeholder="DD/MM/YYYY" value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="vitk_dose"
                                                            name="vitk_dose" placeholder="DD/MM/YYYY" value="">
                                                    </div>
                                                </div>
                                            </div>
