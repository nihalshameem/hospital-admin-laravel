                            ...
                            <form class="mother-visit-form" action="{{ url('patient/an-mother-visit/' . $patient->id) }}"
                             ...
                             <div class="row" style="border: solid 3px #ffb800;padding: 20px;">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="an_visit_mother_name"style="font-size: 16px;font-weight: 600;color: black;">  Mother Name
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="an_visit_mother_name"style="font-size: 16px;font-weight: 600;color: black;">  Husband Name
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="place_name"style="font-size: 16px;font-weight: 600;color: black;">Name of the Facility
                                            </label>
                                            <div class="col-lg-6">
                          ...
                          <div class="row" style="border: solid 3px #ffb800;padding: 20px;">
                                <div class="col-xl-12">
                                  ...
                                  <div class="row">
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Blood Grouping and Typing                                              <span class="text-danger">*</span>
                                                </label>
                                 ...
                                 <div class="row">
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">HIV Status of An Mother                                             <span class="text-danger">*</span>
                                                </label>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">HIV Status of Spouse                                             <span class="text-danger">*</span>
                                                </label>
                                  ...
                                  <div class="row">
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">HbsAg                                             <span class="text-danger">*</span>
                                                </label>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Others                                            <span class="text-danger">*</span>
                                                </label>
            ...
            <!-- Visit Details-->
                                ...
                                <div class="col-xl-12">
                                 ...
                                 <div class="row">
                                  ...
                                  <div class="row">
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Week of Pregancy                                          <span class="text-danger">*</span>
                                                </label>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Urine Albumin                                           <span class="text-danger">*</span>
                                                </label>
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Urine Sugar                                           <span class="text-danger">*</span>
                                                </label>
                                  ...
                                  <div class="row">
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">BP(mm of Hg)
                                                      <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                                        placeholder="eg: 120/150" id="an_mother_weight"
                                                        name="an_mother_weight">
                                                </div>
                                            </div>
                                        </div>
                                          <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">RBS (mg/Dl)
                                                      <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                                        placeholder=" " id="an_mother_weight"
                                                        name="an_mother_weight">
                                                </div>
                                            </div>
                                        </div>
                                   ...
                                   <div class="row">
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">Hb(gm % )
                                                      <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                          ...
                                          <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">Fasting (mg/dl)
                                                      <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                   ...
                                   <div class="row">
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">Severe
                                                      <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                          ...
                                          <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">Post Prandial (mg/dl)
                                                      <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                  ...
                                  <div class="row">
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">GCT(mg/dl)
                                                      <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                          ...
                                          <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">Others
                                                      <span class="text-danger">*</span>
                                                </label>
                                                 <div class="col-lg-6" id="blood_grp">
                                                    <select class="form-control" id="blood_grp" name="blood_grp">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">Thyroid
                                                      <span class="text-danger">*</span>
                                                </label>
                                                 <div class="col-lg-6" id="blood_grp">
                                                    <select class="form-control" id="blood_grp" name="blood_grp">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">OGTT
                                                      <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">ECG
                                                      <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">ECHO
                                                      <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                         ...
                         <!-- USG -->
                          ...
                          <div class="row" style="border: solid 3px #ffb800;padding: 20px;">
                                <div class="col-xl-12">
                                 ...
                                 <div class="row">
                                       <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">No of Fetus
                                                    <span class="text-danger">*</span>
                                                </label>
                                                 <div class="col-lg-6" id="blood_grp">
                                                    <select class="form-control" id="blood_grp" name="blood_grp">
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">AFI ( Amniotic Fluid Index)in cm
                                                    <span class="text-danger">*</span>
                                                </label>
                                                 <div class="col-lg-6" id="blood_grp">
                                                    <select class="form-control" id="blood_grp" name="blood_grp">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Viability                                           <span class="text-danger">*</span>
                                                </label>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Place of fetus                                           <span class="text-danger">*</span>
                                                </label>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Fetal Presentation                                          <span class="text-danger">*</span>
                                                </label>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">BPD (Bi- Parietal Diameter) in mm
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Placental Position                                         <span class="text-danger">*</span>
                                                </label>
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">HC (Head circumference) in mm
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">FHR (Fetal Heart rate) bpm
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">AC (Abdominal circumference) in mm
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">EFW (Estimated Fetal weight) in grms
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">FL (Femur Length) in mm
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_mother_weight" style="font-size: 16px;font-weight: 600;color: black;">Gestational Age (in Weeks)
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                                        placeholder="eg: 32weeks 10days" id="an_mother_weight"
                                                        name="an_mother_weight">
                                                </div>
                                            </div>
                                        </div>
                          ...
                          <div class="row" style="border: solid 3px #ffb800;padding: 20px;">
                                <div class="col-xl-12">
                                   <div class="card-header" style="background-color: #ffb800;">
                                      <h4 class="card-title">Clinical Findings Per Abdomen</h4>
                                   </div>
                                   <br>
                                 ...
                                 <div class="row">
                                       <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Height of the uterus (in Weeks) 
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Fetal Heart Rate (FHR in min) 
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Previous Surgical Scar                                          <span class="text-danger">*</span>
                                                </label>
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Head                                          <span class="text-danger">*</span>
                                                </label>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Abdominal  Wall Oedema                                        <span class="text-danger">*</span>
                                                </label>
                          ...
                          <div class="row" style="border: solid 3px #ffb800;padding: 20px;">
                                <div class="col-xl-12">
                                 ...
                                 <div class="row">
                                       <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Td Dose 
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Td Date
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">FA Tablet
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">FA Date
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">IFA Tablet
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">IFA Date
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Calcium+D3 Tablet
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Calcium+D3 Date
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Albendazole Date
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Others drugs                                          <span class="text-danger">*</span>
                                                </label>
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Parentral Iron
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Inj.Iron sucrose in doses                                          <span class="text-danger">*</span>
                                                </label>
                                         ...
                                         <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Blood transfusion (no of Units) 
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Weeks of pregancy
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="an_visit_date" style="font-size: 16px;font-weight: 600;color: black;">Date
                          ...
                          <div class="row" style="border: solid 3px #ffb800;padding: 20px;">
                                <div class="col-xl-12">
                                 ...
                                 <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="mother_blood"style="font-size: 16px;font-weight: 600;color: black;">Post-Partum Method of Contraception                                          <span class="text-danger">*</span>
                                                </label>
                                                 ...
                                                 <div class="col-lg-6" id="blood_grp">
                                                    <select class="form-control" id="blood_grp" name="blood_grp">
                                                        ...
                                                        <option value="temporary">temporary</option>
                                                         <option value="Male-sterilization-NSV">Male sterilization-NSV  </option>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label text-danger" for="high_risk" style="font-size: 16px;font-weight: 600;color: black;">Category of High Risk 
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                  ...
                                  <div class="col-xl-6">
                                   ...
                                   <div class="col-xl-6">
                                        ...
                                        <div class="col-xl-6">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="abortion_date"style="font-size: 16px;font-weight: 600;color: black;">Suggested place of delivery/Referral facility
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control"
