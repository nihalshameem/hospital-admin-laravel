    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="https://lingamexports.in/public/index" class="brand-logo">
                        ...
                        <ul class="contacts">
                            ...
                            <li class="active dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://lingamexports.in/public/images/avatar/1.jpg" class="rounded-circle user_img"
                                            alt="" />
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://lingamexports.in/public/images/avatar/2.jpg" class="rounded-circle user_img"
                                            alt="" />
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://lingamexports.in/public/images/avatar/3.jpg" class="rounded-circle user_img"
                                            alt="" />
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://lingamexports.in/public/images/avatar/4.jpg" class="rounded-circle user_img"
                                            alt="" />
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://lingamexports.in/public/images/avatar/5.jpg" class="rounded-circle user_img"
                                            alt="" />
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://lingamexports.in/public/images/avatar/4.jpg"
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://lingamexports.in/public/images/avatar/5.jpg"
                                            class="rounded-circle user_img" alt="" />
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                    ...
                    <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                                <img src="https://lingamexports.in/public/images/avatar/1.jpg" class="rounded-circle user_img_msg"
                                    alt="" />
                            </div>
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            ...
                            <div class="img_cont_msg">
                                <img src="https://lingamexports.in/public/images/avatar/2.jpg" class="rounded-circle user_img_msg"
                                    alt="" />
                            </div>
                        </div>
                        <div class="d-flex justify-content-start mb-4">
...
<div class="header">
            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="dashboard_bar">
                        Mother Medical Registration                   </div>
                </div>
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="https://lingamexports.in/public/app-profile" class="dropdown-item ai-icon">
                            ...
                            <a href="https://lingamexports.in/public/email-inbox" class="dropdown-item ai-icon">
                            ...
                            <a class="dropdown-item ai-icon" href="https://lingamexports.in/public/logout" onclick="event.preventDefault();
                            ...
                            <form id="logout-form" action="https://lingamexports.in/public/logout" method="POST"
                                class="d-none">
                                <input type="hidden" name="_token" value="TENxsm8YlUYrqIVu2jFM1FuNz7gieDl9GlrTjXhb">                            </form>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <ul class="metismenu" id="menu">
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                   <li><a href="https://lingamexports.in/public/home">Dashboard</a></li>
                     <li><a href="https://lingamexports.in/public/mupload/">Mother Upload</a></li>
                    <li><a href="https://lingamexports.in/public/patient">Mother Registration</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Mother Medical Registration</h4>
                    </div>
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="patient-form" action="https://lingamexports.in/public/patient/add" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="anc_number">VHN Name
                                                Register
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="anc_number">SL.No of PW in RCH
                                                Register
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="ec_reg_date">Date of AN Mother Registration
                                            </label>
                                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="an_mother">Mother Name
                                            </label>
                                            <div class="col-lg-6">
                                 ...
                                 <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="financial_year">LMP Date
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" id="financial_year"
                                                    name="financial_year" placeholder="YYYY - YYYY">
    ...
    ***********************************-->
    ...
    <!--**********************************
        Scripts
    ***********************************-->
	<script src="https://lingamexports.in/public/vendor/global/global.min.js" type="text/javascript"></script>
					<script src="https://lingamexports.in/public/vendor/bootstrap-select/dist/js/bootstrap-select.min.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/vendor/jquery-validation/jquery.validate.min.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/js/plugins-init/jquery.validate-init.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/vendor/toastr/js/toastr.min.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/js/plugins-init/toastr-init.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/vendor/moment/moment.min.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/vendor/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/vendor/pickadate/picker.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/vendor/pickadate/picker.time.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/vendor/pickadate/picker.date.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/js/plugins-init/bs-daterange-picker-init.js" type="text/javascript"></script>
				<script src="https://lingamexports.in/public/js/plugins-init/pickadate-init.js" type="text/javascript"></script>
