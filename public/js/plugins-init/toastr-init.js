...
*******************/
    ...
    function toaster_message(type, heading, message) {
        if (type == "success") {
            toastr.success(message, heading, toast_structure);
        } else if (type == "error") {
            toastr.error(message, heading, toast_structure);
        } else {
            toastr.info(message, heading, toast_structure);
        }
    }
    if (
        $("#taoster-message").length > 0 &&
        $("#taoster-message").val().length > 0
    ) {
        let h = $("#taoster-heading").val();
        let m = $("#taoster-message").val();
        let t = $("#taoster-type").val();
        toaster_message(t, h, m);
    }
