...
(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        // report mother in phc
        if (jQuery("#report-mother-phc-table").length > 0) {
            var table = $("#report-mother-phc-table").DataTable({
                searching: false,
                paging: true,
                select: false,
                //info: false,
        ...
        // report mother in phc
        if (jQuery("#report-high-risk-phc-table").length > 0) {
            var table = $("#report-high-risk-phc-table").DataTable({
                searching: false,
                paging: true,
                select: false,
                //info: false,
        ...
        $(".slash-format").keypress(function (e) {
            var charCode = e.which ? e.which : event.keyCode;
            let key = event.keyCode || event.charCode;

            if (String.fromCharCode(charCode).match(/[^0-9]/g)) return false;
            if ($(this).val().length >= 7) return false;
            if ($(this).val().length === 3) {
                $(this).val($(this).val() + "/");
            }
        });
        $("#lmp_date").change(function (e) {
            let lmp = $(this).val().split("-");
            let edd = new Date(lmp);
            edd.setMonth(edd.getMonth() + 9);
            edd.setDate(edd.getDate() + 10);
            let picker = $("#edd_date").pickadate("picker");
            picker.set("select", edd);
        });
        // $("#edd_date").change(function (e) {
        //     let edd = $(this).val().split("-");
        //     let lmp = new Date(edd);
        //     lmp.setMonth(lmp.getMonth() - 9);
        //     lmp.setDate(lmp.getDate() - 10);
        //     let picker = $("#lmp_date").pickadate("picker");
        //     picker.set("select", lmp);
        // });
        ...
        function abortion_details() {
            if ($("#abortion_if_any").val() == "yes") {
                $("#week_preg_div").show();
                $("#ab_date_div").show();
                $("#dist_faci_div").show();
    ...
    function searchTable() {
        ...
        $.each($("#risk_search_form").serializeArray(), function (i, field) {
